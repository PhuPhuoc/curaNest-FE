...
const services = [
    ...
    { name: 'Cho ăn', color: 'bg-green-500', hoverColor: 'hover:bg-green-600', textColor: 'text-white' },
    { name: 'Tiêm thuốc', color: 'bg-red-500', hoverColor: 'hover:bg-red-600', textColor: 'text-white' }
];
