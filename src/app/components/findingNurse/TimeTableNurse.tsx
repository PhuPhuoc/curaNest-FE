    ...
    if (id && weekRange) {
      ...
      (async () => {
        ...
        try {
          ...
          console.log("Formatted Work List (role nurser):", formattedWorkList);
  ...
  return (
    <div className="border rounded-lg p-3 shadow-md bg-white mb-10">
      <div className="relative mb-4">
        <p className="text-3xl font-bold text-center">Lịch đã đăng ký</p>
      </div>

      <div>
      {isLoading ? (
          <div className="flex justify-center items-center">
            {/* Sử dụng Loading component từ NextUI */}
